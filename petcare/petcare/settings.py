...
SECRET_KEY = 'django-insecure-j0s%z(pr0iq5x+k$pk7@$%ky!odd1)7tkt*@k(#8vqoip=8b=l'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'sreyakalissery@gmail.com'
EMAIL_HOST_PASSWORD = 'ykze htax ofhl rjmj'
